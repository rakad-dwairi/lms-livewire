                    ...
                    <thead>
                        <tr
                            ...
                            <th class="px-4 py-3">Name
                                <span wire:click="sortBy('author_name')" class="float-right text-sm" style="cursor: pointer;">
                                    <i class="fa fa-arrow-up {{ $sortColumnName === 'author_name' && $sortDirection === 'asc' ? '' : 'text-muted' }}"></i>
                                    <button>{{ $sortColumnName === 'author_name' && $sortDirection === 'asc' ? '' : '_|_' }}</button>   
                                    <button>{{ $sortColumnName === 'author_name' && $sortDirection === 'desc' ? '' : '-|-' }}</button>                          
                                    <i class="fa fa-arrow-down {{ $sortColumnName === 'author_name' && $sortDirection === 'desc' ? '' : 'text-muted' }}"></i>
                                </span>
                            </th>
